...
// 		const site_header = document.querySelector( ".tt-header-inner" );
...
// const showAnim = gsap.from('.tt-header-inner', { 
// 	yPercent: -100,
// 	paused: true,
// 	duration: 0.2
//   }).progress(1);
...
(function ($) {
   ...
   // ============================================================================
	...
	if ($(".ph-share").length) {
		...
		$(".ph-share").on("click", function() {
			$("body").addClass("ph-share-open");
			var tl_prshIn = gsap.timeline();
				 tl_prshIn.to(".ph-share-content", { duration: 0.4, autoAlpha: 1 });
				 tl_prshIn.from(".ph-share-appear", { duration: 0.5, y: 80, autoAlpha: 0, stagger: 0.1, ease: Power2.easeOut }, "+=0.1");
		});
	...
	if ($("#page-header").hasClass("ph-content-parallax")) {
		...
		console.log($(".tt-header-inner").length);
		if ($(".tt-header-inner").length) {
			const showAnim = gsap.from('.tt-header-inner', { 
				yPercent: -100,
				paused: true,
				duration: 0.2
